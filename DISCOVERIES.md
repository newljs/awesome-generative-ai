...
- [Layerive](https://github.com/newljs/Layerive) - Local-first AI image workspace with project version trees, regional and text editing, batch workflows, and user-configured model providers. #opensource.
